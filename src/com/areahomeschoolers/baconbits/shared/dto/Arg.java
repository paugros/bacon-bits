...
public interface Arg {
	...
	public enum EventArg implements Arg, IsSerializable {
		EVENT_ID, AGE_GROUP_ID, REGISTRATION_ID, PARTICIPANT_ID, UPCOMING_NUMBER, INCLUDE_FIELDS, REGISTRATION_ADDED_BY_ID, PARENT_ID, USER_ID, STATUS_ID, PARTICIPANT_IDS, NOT_STATUS_ID, ONLY_COMMUNITY, SERIES_ID, SHOW_INACTIVE, REGISTERED_BY_OR_ADDED_FOR_ID, NEWLY_ADDED, INCLUDE_COMMUNITY;
		private EventArg() {
	...
	public enum UserArg implements Arg, IsSerializable {
		USER_ID, PARENT_ID_PLUS_SELF, PARENT_ID, NOT_ON_REGISTRATION_ID, ORGANIZATION_ID, GROUP_ID, PARENTS, PARENTS_OF_BOYS, PARENTS_OF_GIRLS, CHILDREN, AGES, ONLY_COMMON_INTERESTS, ADDRESS_SEARCH, WITHIN_MILES, WITHIN_LAT, WITHIN_LNG, SEX;
	...
	public enum UserGroupArg implements Arg, IsSerializable {
		ID, USER_ID, USER_IS_ADMIN_OF, USER_NOT_MEMBER_OF, ORG_SUB_DOMAIN;
