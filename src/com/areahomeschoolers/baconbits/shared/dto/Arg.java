...
public interface Arg {
	...
	public enum BookArg implements Arg, IsSerializable {
		USER_ID, STATUS_ID, CATEGORY_ID, GRADE_LEVEL_ID, PRICE_BETWEEN, IDS, ONLINE_ONLY, SOLD_AT_BOOK_SALE, SOLD_ONLINE, NEW_NUMBER, IN_MY_CART, HAS_TAGS, LOCATION_FILTER, CURRENT_ORG_ONLY;
	...
	public enum UserArg implements Arg, IsSerializable {
		USER_ID, PARENT_ID_PLUS_SELF, PARENT_ID, NOT_ON_REGISTRATION_ID, ORGANIZATION_ID, GROUP_ID, ADMIN_OF_GROUP_ID, PARENTS, PARENTS_OF_BOYS, PARENTS_OF_GIRLS, CHILDREN, AGES, ONLY_COMMON_INTERESTS, ADDRESS_SEARCH, SEX, ACTIVE_NUMBER, NEW_NUMBER, HAS_EMAIL, HAS_TAGS, LOCATION_FILTER, REGISTERED_FOR_EVENT_ID;
	...
	public enum UserGroupArg implements Arg, IsSerializable {
		ID, USER_ID, USER_IS_ADMIN_OF, USER_NOT_MEMBER_OF, ORG_SUB_DOMAIN, ORG_DOMAIN, ORGANIZATION_ID;
