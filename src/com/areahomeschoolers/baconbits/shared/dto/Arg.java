...
public interface Arg {
	...
	public enum UserArg implements Arg, IsSerializable {
		USER_ID, PARENT_ID_PLUS_SELF, PARENT_ID, NOT_ON_REGISTRATION_ID, ORGANIZATION_ID, GROUP_ID, ADMIN_OF_GROUP_ID, PARENTS, PARENTS_OF_BOYS, PARENTS_OF_GIRLS, CHILDREN, AGES, ONLY_COMMON_INTERESTS, ADDRESS_SEARCH, WITHIN_MILES, WITHIN_LAT, WITHIN_LNG, SEX, ACTIVE_NUMBER, NEW_NUMBER;
