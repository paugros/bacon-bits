...
/**
 * Indicates whether or not an Attendee will be attending an {@link Appointment}.
 * 
...
public enum Attending implements Serializable, IsSerializable {
	...
	No,
	/**
	 * Indicates an Attendee has not yet made up their mind whether or not they will be attending.
	 */
	Maybe
}
