...
public class NewsPage implements Page {
	...
	private void initialize() {
		...
		Sidebar sb = Sidebar.create(MiniModule.LINKS, MiniModule.MY_EVENTS, MiniModule.NEW_EVENTS, MiniModule.UPCOMING_EVENTS, MiniModule.CITRUS);
	...
	private void initListPage() {
		...
		if (Application.administratorOf(Application.getCurrentOrg())) {
