...
public interface Arg {
	...
	public enum EventArg implements Arg, IsSerializable {
		EVENT_ID, AGE_GROUP_ID, REGISTRATION_ID, PARTICIPANT_ID, UPCOMING_NUMBER, INCLUDE_FIELDS, PARENT_ID, USER_ID, STATUS_ID, ONLY_PAYABLE_PARTICIPANTS, PARTICIPANT_IDS
	}
