...
/**
 * Abstract class for widgets that react to keystrokes and mouse gestures providing a centralized place for the association between user inputs and the logic to
 * perform. Subclasses will implement the <code>onXXXKeyPressed</code>, <code>onMouseDown</code> and <code>onDoubleClick</code> methods to provide the custom
...
public abstract class InteractiveWidget extends Composite {
	...
	/**
	 * Used by focus widget to make sure a key stroke is only handled once by the calendar.
	 */
	...
	/**
	 * Processes {@link com.google.gwt.event.dom.client.KeyCodes.KEY_DELETE} and {@link com.google.gwt.event.dom.client.KeyCodes.KEY_BACKSPACE} keystrokes.
	 ...
	 * 
	 * @param element
	 *            The HTML DOM element that originated the event
	 */
	public abstract void onDoubleClick(Element element, Event event);

	/**
	 * Processes {@link com.google.gwt.event.dom.client.KeyCodes.KEY_DOWN} keystrokes. Concrete interactive widgets should provide the component's specific
	 * logic.
	 */
	public abstract void onDownArrowKeyPressed();

	/**
	 * Processes {@link com.google.gwt.event.dom.client.KeyCodes.KEY_LEFT} keystrokes. Concrete interactive widgets should provide the component's specific
	 * logic.
	 */
	 ...
	 *            The HTML DOM element that originated the event
	 * @param event
	 *            The HTML DOM event that was triggered
	 */
	public abstract void onMouseOver(Element element, Event event);

	/**
	 * Processes {@link com.google.gwt.event.dom.client.KeyCodes.KEY_RIGHT} keystrokes. Concrete interactive widgets should provide the component's specific
	 * logic.
	 */
	public abstract void onRightArrowKeyPressed();

	/**
	 * Processes {@link com.google.gwt.event.dom.client.KeyCodes.KEY_UP} keystrokes. Concrete interactive widgets should provide the component's specific logic.
	 */
	...
	/**
	 * Dispatches the processing of a key being pressed to the this widget <code>onXXXXKeyPressed</code> methods.
	 * 
	 * @param key
	 *            Pressed key code
	 */
